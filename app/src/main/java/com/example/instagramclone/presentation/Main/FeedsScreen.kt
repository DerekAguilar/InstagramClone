            ...
            Scaffold(topBar = {
                    TopAppBar(title={Text(text="Instagram")},
                        navigationIcon = {
                            ...
                            IconButton(onClick = {  }) {
                                Icon(painter = painterResource(id = R.drawable.ic_message), contentDescription ="Message", modifier = Modifier.size(30.dp), tint = Color.Black)
                            }
                        }
                    )
                }, content = {
...
fun PostDescription(it: Post) {
    Text(text = it.postDescription, style = MaterialTheme.typography.bodyLarge, modifier = Modifier
        .padding(8.dp)
        .fillMaxWidth()
        .height(30.dp),
        )
...
fun PostImage(it: Post) {
    Icon(painter = rememberImagePainter(data = it.postImage), contentDescription = null,modifier= Modifier
        .fillMaxWidth()
        .height(450.dp))
...
fun ProfileInfoSection(it: Post) {
    Row(modifier= Modifier
        ...
        Icon(painter = rememberImagePainter(data = it.userImage), contentDescription = "ProfileImage", tint = Color.Unspecified)
        Text(text = it.userName, style = MaterialTheme.typography.bodyLarge, modifier = Modifier
            .padding(8.dp)
